<nav class="nav-tree nobottommargin">
  <ul>
    ...
    <li><a href="update.php"><i class="icon-file-text"></i>Update Events</a></li>
    
    <li><a href="delete.php"><i class="icon-map-marker"></i>Delete Events</a></li>

    <li><a href="change_password.php"><i class="icon-map-marker"></i>Change Password</a></li>

    <li><a href="logout.php"><i class="icon-map-marker"></i>Logout</a></li>
  </ul>
</nav>
