					...
					<div id="posts" class="events small-thumbs">
						...
						<div class="entry clearfix">
							<div class="entry-image d-md-none d-lg-block">
								<a href="#">
									<img src="images/events/home.jpeg" alt="Inventore voluptates velit totam ipsa tenetur">
							...
							<div class="entry-c">
								...
								<div class="entry-content">
									...
									<a href="#" class="button button-small button-circle button-border button-amber"><i class="icon-inbox"></i>Register</a> <a href="#" class="button button-small button-circle button-border button-green"><i class="icon-inbox"></i>Read More</a>
								</div>
							</div>
						</div>
